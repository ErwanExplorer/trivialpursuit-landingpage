...
const questions: Question[] = [
  {
    ...
    explanation: "Il suffit donc d'appliquer une tension de 5V (HIGH) sur le port 13 (l'anode de la LED) pour l'allumer, ou une tension de 0V (LOW) pour l'éteindre."
  },
  {
    id: 2,
    category: "Programmation",
    ...
    correctAnswer: 1,
    difficulty: "Débutant",
    explanation: "Une boucle en programmation est une structure de contrôle qui permet de répéter un bloc de code plusieurs fois."
  },
  {
    id: 3,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Intermédiaire",
    explanation: "PHP est un langage de script côté serveur couramment utilisé pour le développement web."
  },
  {
    id: 4,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Intermédiaire",
    explanation: "Java est traditionnellement le langage de programmation principal pour le développement d'applications Android."
  },
  {
    id: 5,
    category: "Programmation",
    ...
    correctAnswer: 1,
    difficulty: "Débutant",
    explanation: "Opensource (code source ouvert) signifie que le code source est disponible et peut être modifié par quiconque."
  },
  {
    id: 6,
    category: "Programmation",
    ...
    correctAnswer: 1,
    difficulty: "Avancé",
    explanation: "Le cloud computing utilise des réseaux informatiques pour fournir des ressources à la demande sur Internet."
  },
  {
    id: 7,
    category: "Programmation",
    ...
    correctAnswer: 1,
    difficulty: "Intermédiaire",
    explanation: "C++ est un langage de programmation polyvalent et compilé, supportant la programmation orientée objet, générique et procédurale."
  },
  {
    id: 8,
    category: "Programmation",
  ...
  },
  {
    ...
    correctAnswer: 2,
    difficulty: "Débutant",
    explanation: "JavaScript est le langage de script le plus populaire pour le développement web côté client, permettant des pages interactives."
  },
  {
    id: 10,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Intermédiaire",
    explanation: "Swift est le langage de programmation moderne et privilégié pour le développement d'applications iOS et macOS par Apple."
  },
  {
    id: 11,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Avancé",
    explanation: "React Native permet de développer des applications mobiles natives pour iOS et Android à partir d'une seule base de code JavaScript."
  },
  {
    id: 12,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Intermédiaire",
    explanation: "ReactJS est une bibliothèque JavaScript très populaire pour la construction d'interfaces utilisateur interactives pour les applications web."
  },
  {
    id: 13,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Débutant",
    explanation: "CSS (Cascading Style Sheets) est utilisé pour décrire la présentation d'un document écrit en HTML."
  },
  {
    id: 14,
    category: "Programmation",
    ...
    correctAnswer: 1,
    difficulty: "Débutant",
    explanation: "CSS signifie Cascading Style Sheets, un langage de feuille de style utilisé pour la présentation des documents web."
  },
  {
    id: 15,
    category: "Programmation",
    ...
    correctAnswer: 1,
    difficulty: "Débutant",
    explanation: "Une erreur dans un programme est communément appelée un 'bug'."
  },
  {
    id: 16,
    category: "Programmation",
    ...
    correctAnswer: 1,
    difficulty: "Intermédiaire",
    explanation: "La fonction `digitalWrite()` en C++ (notamment pour Arduino) est utilisée pour écrire une valeur (HIGH ou LOW) sur une broche digitale."
  },
  {
    id: 17,
    category: "Programmation",
    ...
    correctAnswer: 1,
    difficulty: "Débutant",
    explanation: "La balise `<a>` en HTML est utilisée pour créer des hyperliens, permettant de naviguer vers d'autres pages ou ressources."
  },
  {
    id: 18,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Intermédiaire",
    explanation: "La syntaxe 'SELECT * FROM table_name' est une commande fondamentale en SQL (Structured Query Language) pour récupérer des données d'une base de données."
  },
  {
    id: 19,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Débutant",
    explanation: "Incrémenter une variable signifie augmenter sa valeur de 1."
  },
  {
    id: 20,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Débutant",
    explanation: "Une fonction est un bloc de code réutilisable qui effectue une tâche spécifique."
  },
  {
    id: 21,
    category: "Programmation",
    ...
    correctAnswer: 1,
    difficulty: "Intermédiaire",
    explanation: "Un algorigramme (ou organigramme) est une représentation graphique des étapes d'un algorithme."
  },
  {
    id: 22,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Débutant",
    explanation: "La balise `<p>` en HTML est utilisée pour définir un paragraphe de texte."
  },
  {
    id: 23,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Intermédiaire",
    explanation: "La fonction `printf` en C++ (issue du C) est utilisée pour afficher des données formatées sur la console."
  },
  {
    id: 24,
    category: "Programmation",
    ...
    correctAnswer: 2,
    difficulty: "Débutant",
    explanation: "Un IDE (Environnement de Développement Intégré) est une suite logicielle qui fournit des outils complets pour le développement de logiciels."
  },
  {
    id: 25,
    category: "Programmation",
    ...
    correctAnswer: 3,
    difficulty: "Débutant",
    explanation: "Les variables de type String (ou des tableaux de caractères comme CHAR en C/C++) sont utilisées pour stocker des caractères alphanumériques."
  }
]
          ...
          <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
            <CardHeader className="text-center pb-8">
              ...
              <CardDescription className="text-lg text-slate-300 max-w-2xl mx-auto">
                Évaluez vos connaissances en programmation avec notre quiz complet. 
                25 questions couvrant différents aspects de la programmation.
              </CardDescription>
            </CardHeader>
